...
const TOOL_REL = 'tools/resample-runtime-01-r6/generate-wgsl.mjs';
...
const MAX_REACH: i32 = 4;`, tileElements: '576',
  ...
  {
    path: `${OUT_DIR}/ewa_aniso_tile_r6_r6.wgsl`, role: 'PRODUCT', profile: 'R6',
    template: 'tools/resample-runtime-01-r6/templates/product-tiled.wgsl.tmpl',
    constants: `const WG_W: u32 = 8u;
const WG_H: u32 = 8u;
const WORKGROUP_INVOCATIONS: u32 = 64u;
...
const MAX_REACH: i32 = 6;`, tileElements: '784',
  ...
  {
    path: `${OUT_DIR}/ewa_aniso_tile_validation_r4_r6.wgsl`, role: 'VALIDATION', profile: 'R4',
    template: 'tools/resample-runtime-01-r6/templates/validation-tiled.wgsl.tmpl',
    constants: `const WG_W: u32 = 8u;
const WG_H: u32 = 8u;
const WORKGROUP_INVOCATIONS: u32 = 64u;
const HALO: i32 = 4;
...
const MAX_REACH: i32 = 4;`, tileElements: '576',
  ...
  {
    path: `${OUT_DIR}/ewa_aniso_tile_validation_r6_r6.wgsl`, role: 'VALIDATION', profile: 'R6',
    template: 'tools/resample-runtime-01-r6/templates/validation-tiled.wgsl.tmpl',
    constants: `const WG_W: u32 = 8u;
const WG_H: u32 = 8u;
const WORKGROUP_INVOCATIONS: u32 = 64u;
...
const MAX_REACH: i32 = 6;`, tileElements: '784',
  ...
  {
    path: `${OUT_DIR}/ewa_aniso_reference_v5_r6.wgsl`, role: 'REFERENCE', profile: 'REFERENCE',
    template: 'tools/resample-runtime-01-r6/templates/reference-direct.wgsl.tmpl', constants: '', tileElements: '',
  },
];
...
export function buildManifest(outputs) {
  ...
  return {
    schemaVersion: 1,
    manifestId: EWA_R6_GENERATED_MANIFEST_ID,
    generatorId: EWA_R6_GENERATOR_ID,
    generatorDigest,
    kernelContractId: EWA_R6_KERNEL_CONTRACT_ID,
...
export function generate({ write = true } = {}) {
  ...
  if (write) {
    ...
    fs.writeFileSync(path.join(ROOT, OUT_DIR, 'ewa_generated_manifest_r6.json'), JSON.stringify(manifest, null, 2) + '\n');
  }
...
if (process.argv[1] && path.resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  console.log(`generated R6 WGSL ${manifest.outputs.length} outputs`);
}
